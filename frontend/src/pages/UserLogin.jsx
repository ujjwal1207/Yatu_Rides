...
const UserLogin = () => {
  ...
  const submitHandler = async (e) => {
    ...
    const response = await axios.post(`${import.meta.env.VITE_BASE}/users/login`, userData)
    ...
    <div className="p-7 h-screen flex flex-col justify-between">
      <div>
        ...
        >
          ...
          <button className="bg-[#111] text-white font-semibold mb-3 rounded-lg px-4 py-2 w-full text-base placeholder:text-base">
            Login
          </button>
        </form>
